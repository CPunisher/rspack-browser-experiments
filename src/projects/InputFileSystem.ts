...
class FileSystemPlugin {
  ...
  apply(compiler: Compiler) {
    compiler.hooks.beforeCompile.tap("FileSystemPlugin", () => {
...
export const projectFs = builtinMemFs.memfs(files);
...
export const config: RspackOptions = {
  ...
  plugins: [
    new FileSystemPlugin(projectFs.fs),
    new BrowserHttpImportEsmPlugin({
      domain: "https://bytepack.coze.cn",
      dependencyUrl: {
        react: "https://cdn-tos-cn.bytedance.net/obj/aipa-tos/react-v18.3.1.js",
      },
    }),
  ],
  experiments: {
